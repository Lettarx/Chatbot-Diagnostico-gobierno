...
def log_solex():
    ...
    st.write("Esta es la página de inicio de Solex. Aquí puedes acceder a todas las funcionalidades del sistema.")
    ...
    if sub and informe_seleccionado:
        st.subheader(f"Informe de {informe_seleccionado['empresa']} - {informe_seleccionado['fecha']}")
